...
class tipo_de_envio(models.Model):
    class EnvioTipo(models.TextChoices):
        paquete = 'P', _('Paquete')
        flete = 'F', _('Flete')
    ...
    tipo = models.CharField(
        max_length=7,
        choices=EnvioTipo.choices,
        null=True,
    )


class envio(models.Model):
    tipo_de_envio = models.ForeignKey('tipo_de_envio', on_delete=models.SET_NULL, null=True)
