...
from .models import *
from .forms import CreateUserForm, CustomerForm, DataForm, Envio
...
# 	context = {}
# 	return render(request, 'portalbelum/login.html', context)
...
def industry(request):
	...
	return render(request, 'portalbelum/industry.html', context)
...
def company(request):
	...
	return render(request, 'portalbelum/company.html', context)
...
# Company DATA QUERIES
	...
	# context = {}
	return render(request, 'portalbelum/historical_data.html', context)
...
def small_industry(request):
	...
	return render(request, 'portalbelum/small_industry.html', context)
...
def large_industry(request):
	...
	return render(request, 'portalbelum/large_industry.html', context)
...
def uploadFile(request):
	...
	return render(request, 'portalbelum/upload.html', {'form': form})
...
def navbarfooter(request):
	...
	return render(request, 'portalbelum/dashboard_navbar_footer.html')
...
def demographicAboriginal(request):
	...
	return render(request, 'portalbelum/demographic_variables/aboriginal.html', context)
...
# Company DATA QUERIES
	...
	return render(request, 'portalbelum/demographic_variables/persons_with_disabilities.html', context)
...
# Company DATA QUERIES
	...
	return render(request, 'portalbelum/demographic_variables/sex.html', context)
...
def demographicMinority(request):
	...
	return render(request, 'portalbelum/demographic_variables/visible_minority.html', context)
...
# Company DATA QUERIES
	...
	return render(request, 'portalbelum/demographic_variables/small_sex.html', context)
...
# Company DATA QUERIES
	...
	return render(request, 'portalbelum/demographic_variables/large_sex.html', context)
...
def small_demographicAboriginal(request):
	...
	return render(request, 'portalbelum/demographic_variables/small_aboriginal.html', context)
...
def large_demographicAboriginal(request):
	...
	return render(request, 'portalbelum/demographic_variables/large_aboriginal.html', context)
...
# Company DATA QUERIES
	...
	return render(request, 'portalbelum/demographic_variables/small_persons_with_disabilities.html', context)
...
# Company DATA QUERIES
	...
	return render(request, 'portalbelum/demographic_variables/large_persons_with_disabilities.html', context)
...
def small_demographicMinority(request):
	...
	return render(request, 'portalbelum/demographic_variables/small_visible_minority.html', context)
...
def large_demographicMinority(request):
	...
	return render(request, 'portalbelum/demographic_variables/large_visible_minority.html', context)
...
def contact(request):
	...
	if request.method == 'POST':
		...
		return render (request, 'portalbelum/contact.html', {'username': username, 'message': message})

	else:
		context = {'username': username, 'dashboarduseremail':dashboarduseremail}
		return render(request, 'portalbelum/contact.html', context)
...
def test(request):
	...
	return render(request, 'portalbelum/test.html', context)
...
def loginPage(request):
	...
	return render(request, 'portalbelum/pages/home.html', context)
...
def portal(request):
	form = Envio()
	if form.is_valid():
		datos_de_envio = envio.objects.create(
			tipo_de_envio = form.cleaned_data['tipo_de_envio'],
    		cp_origen = form.cleaned_data['cp_origen'],
	...
	context = {'form': form}
	return render(request, 'portalbelum/pages/portal.html', context)
...
reply in whatever language you get talked to. \
do not greet more than once during the conversation. \
then offer to share the menu, then collects the order, \
...
def portal_industrial(request):
	...
	context = {}
	return render(request, 'portalbelum/pages/portal_industrial.html', context)
...
def WelcomePage(request):
	...
	return render(request, 'portalbelum/pages/welcome.html', context)
